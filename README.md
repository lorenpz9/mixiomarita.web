...
<style>
    body {
        ...
        background: #000000;
        flex-direction: column; /* To stack the heart and the text vertically */
    }
    .hearth {
        height: 150px;
        width: 150px;
    ...
    .contenido {
        text-align: center;
        margin-top: 20px; /* Add some space between the heart and the text */
    }
    h1, h2 {
        color: white;
        text-decoration: none; /* Remove the white underline */
        margin: 0;
    }
    @keyframes palpitar {
